...
=======
    <form id="meetingForm">
        ...
        <div class="email-group" id="emailGroup">
            <div>
>>>>>>> 7a8f0b51a42ebf2b539bf353d354179b4cf684f5
...
<script>
    ...
    function validateForm() {
        ...
        if (!/^[a-zA-Z ]+$/.test(meetingTitle)) {
            alert("Meeting Title can only contain letters and spaces.");
            return false;
        }
